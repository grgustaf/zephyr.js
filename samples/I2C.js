...
//   - choose resistors that will work with the LCD hardware you have; the
//     ones we listed here worked for us
//   - so your mileage may vary if you have different LCD
// Wiring:
//   For LCD:
//     - Wire SDA on the LCD to the pull-up resistor and connect that resistor
//       to power (VCC)
//     - Wire SCL on the LCD to the pull-up resistor and connect that resistor
//       to power (VCC)
